...
const config: Config = {
  ...
  sites: [
    ...
    {
      name: "Blocksy",
      description: "Blocksy development environment",
 ...
 */
export function setExportSite(nameOrIndex: string | number): SiteProfile | undefined {
 ...
 */
export function setImportSite(nameOrIndex: string | number): SiteProfile | undefined {
  let site: SiteProfile | undefined;
 ...
 */
export function listSites(): {index: number; name: string; description?: string}[] {
